...
export class VentaService {
  ...
  url = 'https://organic-space-halibut-6777q564w55hrj4v-4000.app.github.dev/api/ventas'; //'https://solid-enigma-49995v4wrrph7vx7-4000.app.github.dev/api/ventas' o 'http://localhost:4000/api/ventas'

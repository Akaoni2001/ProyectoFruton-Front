...
export class CategoriaService {
  ...
  url = 'http://localhost:4000/api/categorias'//'https://organic-space-halibut-6777q564w55hrj4v-4000.app.github.dev/api/categorias'; //'https://solid-enigma-49995v4wrrph7vx7-4000.app.github.dev/api/categorias' o 'http://localhost:4000/api/categorias'

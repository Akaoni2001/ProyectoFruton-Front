...
export class ProductoService {
  ...
  url='https://curly-robot-rvvvq69p6wpf59xv-4000.app.github.dev/api/productos' //'https://organic-space-halibut-6777q564w55hrj4v-4000.app.github.dev/api/productos'; //'https://solid-enigma-49995v4wrrph7vx7-4000.app.github.dev/api/productos' o 'http://localhost:4000/api/productos'
